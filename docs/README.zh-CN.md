...
Vibe Coding Context Engineering 是一套面向 Codex 的 AI 编程工作流工程化模板。它把 Vibe Coding B+ 落成项目规则、Codex hooks、确定性验收脚本、可复用 skill，以及可安装的本地 Codex plugin。
...
- `.agents/skills/vibe-coding-3/`，提供 Vibe Coding B+ 的 Codex skill。
